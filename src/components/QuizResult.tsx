    ...
    <div style={{
      ...
      <div style={{
        ...
        <Link href={`/history/${quiz.id}`}>
          <Button type="default" style={{ height: 40, padding: '0 24px', fontWeight: 600, borderRadius: 8, border: '1px solid var(--color-border)', background: 'transparent' }}>
            Review Answers
          </Button>
        </Link>
        <Link href="/quiz">
          <Button type="primary" style={{ height: 40, padding: '0 24px', fontWeight: 600, borderRadius: 8, border: 'none' }}>
            New Quiz
          </Button>
        </Link>
      </div>
