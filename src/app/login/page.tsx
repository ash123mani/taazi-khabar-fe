      ...
      <div className="bg-surface-card border border-surface-border rounded-lg p-8">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-surface-card px-2 text-text-muted">or continue with</span>
          </div>
        </div>

        <button
          onClick={() => signIn('google', { callbackUrl: '/' })}
          className="w-full bg-surface hover:bg-surface-border text-text-secondary border border-surface-border py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2"
        >
